...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'customers_customer', 'customer_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.CustomerType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.customer_type'
        db.delete_column(u'customers_customer', 'customer_type_id')
