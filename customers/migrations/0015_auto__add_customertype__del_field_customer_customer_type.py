...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'customers_customertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'customers', ['CustomerType'])

        # Deleting field 'Customer.customer_type'
        db.delete_column(u'customers_customer', 'customer_type')


    def backwards(self, orm):
        # Deleting model 'CustomerType'
        db.delete_table(u'customers_customertype')
