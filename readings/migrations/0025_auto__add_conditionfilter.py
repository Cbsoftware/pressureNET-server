...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConditionFilter'
        db.create_table(u'readings_conditionfilter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'readings', ['ConditionFilter'])


    def backwards(self, orm):
        # Deleting model 'ConditionFilter'
        db.delete_table(u'readings_conditionfilter')
